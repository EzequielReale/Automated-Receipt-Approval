...
- **Retry Mechanism**: As the system is tuned for the provided 10,000 TPM limit, a retry mechanism was implemented: if the AI service returns a 429 error, the backend waits for 60 seconds and attempts the request one more time automatically.
